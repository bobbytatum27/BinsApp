    ...
    return (
      <View style={ styles.container }>
        ...
        <ScrollView>
          ...
          <Text style={styles.text}>Simply press "Request a Delivery" or "Request a Pickup" and select the items you want stored. Then, schedule your appointment and we'll come by to pick up/drop off your items.</Text>
          <Text style={styles.header}>How Do I Create a New Bin?</Text>
          <Text style={styles.text}>First, pack up a bin with the belongings you want. Then, under "Items with You", you can create a new item by taking a photo and adding a description. Now it will be ready to be stored.</Text>
