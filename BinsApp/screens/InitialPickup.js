...
export default class InitialPickup extends Component {
  ...
  getSelected() {
    ...
    this.props.navigation.navigate('BillingInfoScreen', {selected: list, dateSelected: this.props.route.params.dateSelected, timeSelected: this.props.route.params.timeSelected})
  }
